# Task 2 - Product and Category Management System
...
## Relationship
One Category can contain many Products. `Product.Category_ID` references `Category.Category_ID`.
...
SELECT c.Category_Name,
       ...
       SUM(p.Price * p.Stock) AS Stock_Value
FROM Category c
